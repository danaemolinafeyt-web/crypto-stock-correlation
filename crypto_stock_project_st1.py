...
btc = yf.download("BTC-USD", start="2010-07-17", end="2026-03-01")

# This code will pull S&P 500 data

sp500 = yf.download("^GSPC", start="2010-07-17", end="2026-02-27")
...
# Correlation between Bitcoin and S&P 500: 0.23